...
interface UtilisateurSQL
{
	...
	public const SQL_MODIFIER_UTILISATEUR = "UPDATE utilisateur SET prenom = :prenom , mail = :mail , avatar = :avatar WHERE id = :id";
    ...
    public const SQL_SELECT_UTILISATEUR_ID = "SELECT *  FROM utilisateur WHERE id = :id";
